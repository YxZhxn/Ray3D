data_config = {
    # 3D pose dataset
    'DATASET': 'h36m_aug',  #  h36m, humaneva, aibee
    ...
    'GT_3D': '/ssd/yzhan/data/benchmark/3D/h36m/annotations/gt/data_3d_h36m.npz',
    'GT_2D': '',
    'CAMERA_PARAM': '',
    'TRAIN_CAMERA_PARAM': '/ssd/yzhan/data/benchmark/3D/h36m/annotations/camera.augmentation.rlweng/training.json',
    'TEST_CAMERA_PARAM': '/ssd/yzhan/data/benchmark/3D/h36m/annotations/camera.augmentation.rlweng/testing.json',
