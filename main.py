...
def main():
    ...
    from lib.dataloader.data_loader import TrainPoseDataSet, TestPoseDataSet
    train_dataset = TrainPoseDataSet(data_config, model_config)
    test_dataset = TestPoseDataSet(data_config, model_config)
    kps_left, kps_right = train_dataset.get_3d_joints()
    joints_left, joints_right = train_dataset.get_3d_joints()
    ...
    train_generator = DataLoader(
        ...
        shuffle=True,
        num_workers=16)
    test_generator = test_dataset  # use dataset as dataloader
